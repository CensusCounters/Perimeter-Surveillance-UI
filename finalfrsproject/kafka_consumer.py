...
def start_kafka_consumer(socketio):
    try:
        ...
        for event in consumer:
            if event:
                ...
                # socketio.emit('new_message', {'data': event.value, 'alert_id': 1}, namespace='/home')
                socketio.sleep(1)
                socketio.emit('event_data', {'data': event.value, 'alert_id': 1})
                print("-------------------- KAFKA END ---------------------\n\n")
